                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="username" type="text" class="form-control @error('username') is-invalid @enderror my-2" name="username" value="{{ old('username') }}" required autocomplete="username" autofocus>
                        ...
                        <div class="form-group row mb-6">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="file" class="form-control my-2" name="file" required autocomplete="new-password">
                            </div>
                        </div>
...
@endcomponent('components.master)
